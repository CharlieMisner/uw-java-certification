...
public class ProtocolConstants {
    ...
    public static String ELEMENT_DELIMITER = ":";
    ...
    public static int PRICE_CHANGE_EVNT_TICKER_ELEMENT = 1;

    public static int QUOTE_CMD_TICKER_ELEMENT = 1;

    public static String SELL_ORDER = "SELL_ORDER";
