...
public class Figures
{
    ...
    /**
     * Created south oval to test oval draw method.
     */
    private double      southOvalX  = areaWidth / 2 - width / 2 + xOffset;
    private double      southOvalY  = 7*yOffset;
    private GeoPoint    southOvalOr = new GeoPoint( southOvalX, southOvalY );
     ...
     * Created south oval to test oval draw method.
     */
    private void southOval()
    {
        GeoRectangle    oval    =
                new GeoOval( southOvalOr, null, width, height );
